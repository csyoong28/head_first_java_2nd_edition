...
public class T11_BinaryOperator {
	public static void main(String[] args) {
		binaryOperatorDemo();
		binaryOperatorSumAllValues();
		binaryOperatorFindMaxMin();
	}
	...
	public static void binaryOperatorSumAllValues() {
	...
	public static void binaryOperatorFindMaxMin() {
